...
class MissionExecutorNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(
            f"Mission executor ready: api={self.api_base}, dry_run={self.dry_run}, robot_id={self.robot_id}"
        )
    ...
    def set_status(self, mission_id: int, status: str, error_reason: Optional[str] = None):
        ...
        return self.api_request("PATCH", f"/missions/{mission_id}/status", payload)
