...
class Metaclass_SetJoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'm3pro_teacher_interfaces.srv.SetJoints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from m3pro_teacher_interfaces.srv import _set_joints
...
class SetJoints(metaclass=Metaclass_SetJoints):
    from m3pro_teacher_interfaces.srv._set_joints import SetJoints_Request as Request
    from m3pro_teacher_interfaces.srv._set_joints import SetJoints_Response as Response
