...
#include "m3pro_teacher_interfaces/srv/detail/set_joints__rosidl_typesupport_fastrtps_c.h"
...
using _SetJoints_Request__ros_msg_type = m3pro_teacher_interfaces__srv__SetJoints_Request;
...
size_t get_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetJoints_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_m3pro_teacher_interfaces
size_t max_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = m3pro_teacher_interfaces__srv__SetJoints_Request;
    is_plain =
      (
...
static size_t _SetJoints_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, m3pro_teacher_interfaces, srv, SetJoints_Request)() {
...
using _SetJoints_Response__ros_msg_type = m3pro_teacher_interfaces__srv__SetJoints_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_m3pro_teacher_interfaces
size_t get_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetJoints_Response__ros_msg_type * ros_message = static_cast<const _SetJoints_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_m3pro_teacher_interfaces
size_t max_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = m3pro_teacher_interfaces__srv__SetJoints_Response;
    is_plain =
      (
...
static size_t _SetJoints_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_m3pro_teacher_interfaces__srv__SetJoints_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, m3pro_teacher_interfaces, srv, SetJoints_Response)() {
...
// already included above
// #include "m3pro_teacher_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "m3pro_teacher_interfaces/srv/set_joints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, m3pro_teacher_interfaces, srv, SetJoints)() {
