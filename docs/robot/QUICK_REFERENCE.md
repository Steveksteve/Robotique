...
- [OK] How SLAM builds maps using lidar + odometry
- [OK] How loop closure corrects cumulative drift
- [OK] How AMCL localizes a robot on a known map
- [OK] How Nav2 plans and tracks paths
- [OK] How costmaps prevent collisions
- [OK] How color-space (HSV) improves object detection
- [OK] How inverse kinematics controls the arm
- [OK] How ROS2 systems integrate sensors, algorithms, and UI
- [OK] How WebSockets bridge ROS2 to web browsers
...
Pour le diagnostic, consulter la section 10 de `TECHNICAL_REFERENCE.md`.
